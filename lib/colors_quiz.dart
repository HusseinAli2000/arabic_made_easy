...
class ColorsQuiz extends StatefulWidget {
  const ColorsQuiz({super.key});

  @override
  State<ColorsQuiz> createState() => _ColorsQuizState();
}

class _ColorsQuizState extends State<ColorsQuiz> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      flashCardNotifier.generateAllColorsWords();
