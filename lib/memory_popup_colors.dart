...
class MemoryPopupColors extends StatefulWidget {
  const MemoryPopupColors({super.key});

  @override
  State<MemoryPopupColors> createState() => _MemoryPopupColorsState();
}

class _MemoryPopupColorsState extends State<MemoryPopupColors> {
  @override
