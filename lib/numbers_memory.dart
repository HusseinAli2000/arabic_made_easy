...
import 'memory_popup_numbers.dart';

class NumbersMemory extends StatefulWidget {
  const NumbersMemory({super.key});

  @override
  State<NumbersMemory> createState() => _NumbersMemoryState();
}

class _NumbersMemoryState extends State<NumbersMemory> {
  List<WordMemory> _gridWords = [];
  List<WordMemory> sourceWords = NumbersMemoryOption.getSourceWords();
              ...
              WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
                if (notifier.roundCompleted) {
                  showDialog(
                      ...
                      context: context,
                      builder: (context) => const MemoryPopupNumbers());
                }
              });
