...
class BasicphrasesMcqFive extends StatefulWidget {
  const BasicphrasesMcqFive({super.key});

  @override
  State<BasicphrasesMcqFive> createState() => _BasicphrasesMcqFiveState();
}

class _BasicphrasesMcqFiveState extends State<BasicphrasesMcqFive> {
  final List<String> _words = BasicPhrases.toList();
  late String _word;
