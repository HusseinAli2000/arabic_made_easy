...
class AlphabetMcqTen extends StatefulWidget {
  const AlphabetMcqTen({super.key});

  @override
  State<AlphabetMcqTen> createState() => _AlphabetMcqTenState();
}

class _AlphabetMcqTenState extends State<AlphabetMcqTen> {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Center(
            child: Text(
              '10 Alphabet Multiple Choice Quiz',
              style: TextStyle(
                fontFamily: 'Akaya',
                fontSize: 25,
                color: Color.fromARGB(255, 235, 234, 243),
