...
class CuwFlashcards extends StatefulWidget {
  const CuwFlashcards({super.key});

  @override
  State<CuwFlashcards> createState() => _CuwFlashcardsState();
}

class _CuwFlashcardsState extends State<CuwFlashcards> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      flashCardNotifier.generateAllCuwWords();
