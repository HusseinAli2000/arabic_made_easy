...
class MemoryPopupBodyparts extends StatefulWidget {
  const MemoryPopupBodyparts({super.key});

  @override
  State<MemoryPopupBodyparts> createState() => _MemoryPopupBodypartsState();
}

class _MemoryPopupBodypartsState extends State<MemoryPopupBodyparts> {
  @override
