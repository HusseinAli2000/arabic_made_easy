...
class NumbersMcqTwenty extends StatefulWidget {
  const NumbersMcqTwenty({super.key});

  @override
  State<NumbersMcqTwenty> createState() => _NumbersMcqTwentyState();
}

class _NumbersMcqTwentyState extends State<NumbersMcqTwenty> {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Center(
            child: Text(
              '20 Numbers Multiple Choice Quiz',
              style: TextStyle(
                fontFamily: 'Akaya',
                fontSize: 25,
                color: Color.fromARGB(255, 235, 234, 243),
