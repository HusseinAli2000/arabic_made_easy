...
import 'colors_mcq_five.dart';
import 'colors_mcq_ten.dart';

class ColorsMcq extends StatefulWidget {
  const ColorsMcq({super.key});

  @override
  State<ColorsMcq> createState() => _ColorsMcqState();
}

class _ColorsMcqState extends State<ColorsMcq> {
  @override
