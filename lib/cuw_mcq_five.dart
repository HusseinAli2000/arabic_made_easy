...
class CuwMcqFive extends StatefulWidget {
  const CuwMcqFive({super.key});

  @override
  State<CuwMcqFive> createState() => _CuwMcqFiveState();
}

class _CuwMcqFiveState extends State<CuwMcqFive> {
  final List<String> _words = CuwWords.toList();
  late String _word;
