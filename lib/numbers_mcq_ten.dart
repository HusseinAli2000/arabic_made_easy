...
class NumbersMcqTen extends StatefulWidget {
  const NumbersMcqTen({super.key});

  @override
  State<NumbersMcqTen> createState() => _NumbersMcqTenState();
}

class _NumbersMcqTenState extends State<NumbersMcqTen> {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Center(
            child: Text(
              '10 Numbers Multiple Choice Quiz',
              style: TextStyle(
                fontFamily: 'Akaya',
                fontSize: 25,
                color: Color.fromARGB(255, 235, 234, 243),
