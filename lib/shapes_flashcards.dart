...
class ShapesFlashcards extends StatefulWidget {
  const ShapesFlashcards({super.key});

  @override
  State<ShapesFlashcards> createState() => _ShapesFlashcardsState();
}

class _ShapesFlashcardsState extends State<ShapesFlashcards> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      flashCardNotifier.generateAllShapesWords();
