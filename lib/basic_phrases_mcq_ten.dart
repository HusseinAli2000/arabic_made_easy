...
class BasicphrasesMcqTen extends StatefulWidget {
  const BasicphrasesMcqTen({super.key});

  @override
  State<BasicphrasesMcqTen> createState() => _BasicphrasesMcqTenState();
}

class _BasicphrasesMcqTenState extends State<BasicphrasesMcqTen> {
