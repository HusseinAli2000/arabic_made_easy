...
class DatabaseManager {
  ...
  Future<Database> initDatabase() async {
    ...
    return await openDatabase(path, onCreate: (db, version) {
      db.execute(
          'CREATE TABLE $_table($_column1 TEXT, $_column2 TEXT PRIMARY KEY, $_column3 TEXT, $_column4 TEXT)');
    }, version: 1);
  }
  ...
  Future<List<Word>> selectWord({int? limit}) async {
    final db = await initDatabase();
