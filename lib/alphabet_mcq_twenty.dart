...
class AlphabetMcqTwenty extends StatefulWidget {
  const AlphabetMcqTwenty({super.key});

  @override
  State<AlphabetMcqTwenty> createState() => _AlphabetMcqTwentyState();
}

class _AlphabetMcqTwentyState extends State<AlphabetMcqTwenty> {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Center(
            child: Text(
              '20 Alphabet Multiple Choice Quiz',
              style: TextStyle(
                fontFamily: 'Akaya',
                fontSize: 25,
                color: Color.fromARGB(255, 235, 234, 243),
