...
import 'animals.dart';
import 'shapes_mcq_ten.dart';

class ShapesMcq extends StatefulWidget {
  const ShapesMcq({super.key});

  @override
  State<ShapesMcq> createState() => _ShapesMcqState();
}

class _ShapesMcqState extends State<ShapesMcq> {
  @override
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const ShapesMcqTen(),
                          ),
                        );
                      },
                      style: ButtonStyle(
