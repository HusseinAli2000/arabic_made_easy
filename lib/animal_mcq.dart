...
class AnimalMCQ extends StatefulWidget {
  const AnimalMCQ({super.key});

  @override
  State<AnimalMCQ> createState() => _AnimalMCQState();
}

class _AnimalMCQState extends State<AnimalMCQ> {
  @override
