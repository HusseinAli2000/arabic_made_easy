...
class BodypartsFlashcards extends StatefulWidget {
  const BodypartsFlashcards({super.key});

  @override
  State<BodypartsFlashcards> createState() => _BodypartsFlashcardsState();
}

class _BodypartsFlashcardsState extends State<BodypartsFlashcards> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      flashCardNotifier.generateAllBodypartsWords();
