...
class TransportFlashcards extends StatefulWidget {
  const TransportFlashcards({super.key});

  @override
  State<TransportFlashcards> createState() => _TransportFlashcardsState();
}

class _TransportFlashcardsState extends State<TransportFlashcards> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      flashCardNotifier.generateAllTransportWords();
