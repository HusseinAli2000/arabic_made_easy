...
import 'animals.dart';
import 'bodyparts_mcq_five.dart';
import 'bodyparts_mcq_ten.dart';

class BodyPartsMcq extends StatefulWidget {
  const BodyPartsMcq({super.key});

  @override
  State<BodyPartsMcq> createState() => _BodyPartsMcqState();
}

class _BodyPartsMcqState extends State<BodyPartsMcq> {
  @override
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const BodyPartsMcqFive(),
                          ),
                        );
                      },
                      style: ButtonStyle(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const BodyPartsMcqTen(),
                          ),
                        );
                      },
                      style: ButtonStyle(
