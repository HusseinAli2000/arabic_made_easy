...
import 'package:arabic_made_easy/memory_popup_alphabet.dart';
import 'package:arabic_made_easy/memory_popup_shapes.dart';
...
class AlphabetMemory extends StatefulWidget {
  const AlphabetMemory({super.key});

  @override
  State<AlphabetMemory> createState() => _AlphabetMemoryState();
}

class _AlphabetMemoryState extends State<AlphabetMemory> {
  List<WordMemory> _gridWords = [];
  List<WordMemory> sourceWords = AlphabetMemoryOption.getSourceWords();
              ...
              WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
                if (notifier.roundCompleted) {
                  showDialog(
                      ...
                      context: context,
                      builder: (context) => MemoryPopupAlphabet());
                }
              });
