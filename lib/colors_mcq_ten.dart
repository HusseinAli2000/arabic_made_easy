...
class ColorsMcqTen extends StatefulWidget {
  const ColorsMcqTen({super.key});

  @override
  State<ColorsMcqTen> createState() => _ColorsMcqTenState();
}

class _ColorsMcqTenState extends State<ColorsMcqTen> {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Center(
            child: Text(
              '10 Colors Multiple Choice Quiz',
              style: TextStyle(
                fontFamily: 'Akaya',
                fontSize: 25,
                color: Color.fromARGB(255, 235, 234, 243),
