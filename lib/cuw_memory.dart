...
import 'memory_popup_cuw.dart';

class CuwMemory extends StatefulWidget {
  const CuwMemory({super.key});

  @override
  State<CuwMemory> createState() => _CuwMemoryState();
}

class _CuwMemoryState extends State<CuwMemory> {
  List<WordMemory> _gridWords = [];
  List<WordMemory> sourceWords = CuwMemoryOption.getSourceWords();
              ...
              return MaterialApp(
                ...
                home: Scaffold(
                  ...
                  appBar: AppBar(
                    ...
                    title: const Center(
                      child: Text(
                        'Commonly Used Words Memory Game',
                        style: TextStyle(
                          fontFamily: 'Akaya',
                          fontSize: 25,
                          color: Color.fromARGB(255, 235, 234, 243),
