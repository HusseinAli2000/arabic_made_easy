...
import 'package:arabic_made_easy/numbers_mcq_twenty.dart';
...
class NumbersMcq extends StatefulWidget {
  ...
  @override
  State<NumbersMcq> createState() => _NumbersMcqState();
}

class _NumbersMcqState extends State<NumbersMcq> {
  @override
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const NumbersMcqFive(),
                          ),
                        );
                      },
                      style: ButtonStyle(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const NumbersMcqTen(),
                          ),
                        );
                      },
                      style: ButtonStyle(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const NumbersMcqTwenty(),
                          ),
                        );
                      },
                      style: ButtonStyle(
