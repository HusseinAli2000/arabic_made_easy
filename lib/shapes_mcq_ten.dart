...
class ShapesMcqTen extends StatefulWidget {
  const ShapesMcqTen({super.key});

  @override
  State<ShapesMcqTen> createState() => _ShapesMcqTenState();
}

class _ShapesMcqTenState extends State<ShapesMcqTen> {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Center(
            child: Text(
              '10 Shapes Multiple Choice Quiz',
              style: TextStyle(
                fontFamily: 'Akaya',
                fontSize: 25,
                color: Color.fromARGB(255, 235, 234, 243),
