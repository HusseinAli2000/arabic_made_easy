...
class AlphabetMcqFive extends StatefulWidget {
  const AlphabetMcqFive({super.key});

  @override
  State<AlphabetMcqFive> createState() => _AlphabetMcqFiveState();
}

class _AlphabetMcqFiveState extends State<AlphabetMcqFive> {
  final List<String> _words = AlphabetWords.toList();
  late String _word;
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Center(
            child: Text(
              '5 Alphabet Multiple Choice Quiz',
              style: TextStyle(
                fontFamily: 'Akaya',
                fontSize: 25,
                color: Color.fromARGB(255, 235, 234, 243),
