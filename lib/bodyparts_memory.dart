...
class BodyPartsMemory extends StatefulWidget {
  const BodyPartsMemory({super.key});

  @override
  State<BodyPartsMemory> createState() => _BodyPartsMemoryState();
}

class _BodyPartsMemoryState extends State<BodyPartsMemory> {
  List<WordMemory> _gridWords = [];
  List<WordMemory> sourceWords = BodyPartsMemoryOption.getSourceWords();
              ...
              WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
                if (notifier.roundCompleted) {
                  showDialog(
                      ...
                      context: context,
                      builder: (context) => const MemoryPopupBodyparts());
                }
              });
