...
class AnimalMCQTwenty extends StatefulWidget {
  const AnimalMCQTwenty({super.key});

  @override
  State<AnimalMCQTwenty> createState() => _AnimalMCQTwentyState();
}

class _AnimalMCQTwentyState extends State<AnimalMCQTwenty> {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Center(
            child: Text(
              '20 Animals Multiple Choice Quiz',
              style: TextStyle(
                fontFamily: 'Akaya',
                fontSize: 25,
                color: Color.fromARGB(255, 235, 234, 243),
