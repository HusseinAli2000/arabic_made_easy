...
class BodyPartsMcqTen extends StatefulWidget {
  const BodyPartsMcqTen({super.key});

  @override
  State<BodyPartsMcqTen> createState() => _BodyPartsMcqTenState();
}

class _BodyPartsMcqTenState extends State<BodyPartsMcqTen> {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Center(
            child: Text(
              '10 Body Parts Multiple Choice Quiz',
              style: TextStyle(
                fontFamily: 'Akaya',
                fontSize: 25,
                color: Color.fromARGB(255, 235, 234, 243),
